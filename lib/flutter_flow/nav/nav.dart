      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'communityVisions',
              path: 'communityVisions',
              requireAuth: true,
              builder: (context, params) => CommunityVisionsWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              name: 'Main_trackerCopy',
              path: 'mainTrackerCopy',
              requireAuth: true,
              builder: (context, params) => MainTrackerCopyWidget(),
            ),
            FFRoute(
              name: 'createTaskCopy',
              path: 'createTaskCopy',
              ...
              builder: (context, params) => CreateTaskCopyWidget(
                projectParameter:
            ...
            FFRoute(
              ...
              builder: (context, params) => NewCreateTaskWidget(
                projectParameter:
                    params.getParam('projectParameter', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'Main_projectsWebCopy',
              path: 'mainProjectsWebCopy',
              requireAuth: true,
              builder: (context, params) => MainProjectsWebCopyWidget(),
            ),
            FFRoute(
              name: 'test',
              path: 'test',
            ...
            FFRoute(
              ...
              requireAuth: true,
              builder: (context, params) => EditProfileCopyWidget(),
            ),
            FFRoute(
              name: 'test2',
              path: 'test2',
            ...
            FFRoute(
              name: 'projectDetailsPageCopy',
              path: 'projectDetailsPageCopy',
              requireAuth: true,
              asyncParams: {
                'projectRef': getDoc(['projects'], ProjectsRecord.serializer),
              },
              builder: (context, params) => ProjectDetailsPageCopyWidget(
                projectRef: params.getParam('projectRef', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'projectDetailsPage2a',
              path: 'projectDetailsPage2a',
              requireAuth: true,
              asyncParams: {
                'projectRef': getDoc(['projects'], ProjectsRecord.serializer),
              },
              builder: (context, params) => ProjectDetailsPage2aWidget(
                projectRef: params.getParam('projectRef', ParamType.Document),
                tabIndex: params.getParam('tabIndex', ParamType.int),
                fromTask: params.getParam('fromTask', ParamType.bool),
              ),
            ),
            FFRoute(
              name: 'VisionBoardPage1aCopy',
              path: 'visionBoardPage1aCopy',
              requireAuth: true,
              builder: (context, params) => VisionBoardPage1aCopyWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              name: 'createProjectCopy2',
              path: 'createProjectCopy2',
              requireAuth: true,
              builder: (context, params) => CreateProjectCopy2Widget(),
            ),
            FFRoute(
              name: 'test3',
              path: 'test3',

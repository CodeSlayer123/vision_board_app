  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<OrganizationsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<OrganizationsRecord> joinCommunityOrganizationsRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final joinCommunityOrganizationsRecord =
            joinCommunityOrganizationsRecordList.isNotEmpty
                ? joinCommunityOrganizationsRecordList.first
                : null;
                                ...
                                if (joinCommunityOrganizationsRecord != null) {
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        title: Text('No Community Found!'),
                                        content:
                                            Text('Try a different Invite Link'),
                                        actions: [
                                          TextButton(

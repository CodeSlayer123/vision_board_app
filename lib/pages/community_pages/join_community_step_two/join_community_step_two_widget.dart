...
import 'join_community_step_two_model.dart';
export 'join_community_step_two_model.dart';

class JoinCommunityStepTwoWidget extends StatefulWidget {
  const JoinCommunityStepTwoWidget({
    Key? key,
    this.inviteCode,
  }) : super(key: key);
  ...
  @override
  _JoinCommunityStepTwoWidgetState createState() =>
      _JoinCommunityStepTwoWidgetState();
}

class _JoinCommunityStepTwoWidgetState extends State<JoinCommunityStepTwoWidget>
    with TickerProviderStateMixin {
  late JoinCommunityStepTwoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JoinCommunityStepTwoModel());
                ...
                Align(
                  ...
                  child: StreamBuilder<List<OrganizationsRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<OrganizationsRecord> columnOrganizationsRecordList =
                          snapshot.data!;
                      ...
                      final columnOrganizationsRecord =
                          columnOrganizationsRecordList.isNotEmpty
                              ? columnOrganizationsRecordList.first
                              : null;
                      return Column(
                        mainAxisSize: MainAxisSize.max,
                        children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Image.network(
                                    columnOrganizationsRecord!.orgLogo!,
                                    fit: BoxFit.cover,
                                  ),
                                ),
                              ],
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  columnOrganizationsRecord!.orgName!,
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  columnOrganizationsRecord!.orgDescription!,
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: FlutterFlowTheme.of(context)
                              ...
                              child: Container(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    await columnOrganizationsRecord!.reference
                                        .update(organizationsUpdateData);

                                    final usersUpdateData = {
                                      'Communities': FieldValue.arrayUnion([
                                        columnOrganizationsRecord!.reference
                                      ]),
                                    };

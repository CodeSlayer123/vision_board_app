...
import 'create_community_model.dart';
export 'create_community_model.dart';
...
class _CreateCommunityWidgetState extends State<CreateCommunityWidget>
  ...
  void initState() {
    ...
    _model.communityNameController ??= TextEditingController();
    ...
    return StreamBuilder<List<OrganizationsRecord>>(
      stream: queryOrganizationsRecord(
        queryBuilder: (organizationsRecord) => organizationsRecord
            .where('InviteCode', isEqualTo: _model.inviteCode),
        singleRecord: true,
      ),
      builder: (context, snapshot) {
        ...
        List<OrganizationsRecord> createCommunityOrganizationsRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final createCommunityOrganizationsRecord =
            createCommunityOrganizationsRecordList.isNotEmpty
                ? createCommunityOrganizationsRecordList.first
                : null;
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    16.0, 16.0, 16.0, 0.0),
                                child: TextFormField(
                                  controller: _model.communityNameController,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    labelText:
                                        FFLocalizations.of(context).getText(
                                      'c5k1l5qp' /* Community Name */,
                                    ),
                                    hintStyle:
                                  ...
                                  validator: _model
                                      .communityNameControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      'rmid2uu0' /* Enter description here.. */,
                                    ),
                                    hintStyle:
                                        FlutterFlowTheme.of(context).bodySmall,
                                    enabledBorder: OutlineInputBorder(
                          ...
                          onPressed: () async {
                            ...
                            final organizationsCreateData = {
                              ...createOrganizationsRecordData(
                                orgName: _model.communityNameController.text,
                                orgLogo: _model.uploadedFileUrl1,
                                orgDescription: _model.shortBioController.text,
                                orgAdmin: currentUserReference,
                                inviteCode: _model.inviteCode,
                              ),
                              'createdOn': FieldValue.serverTimestamp(),
                              'OrgMembers': [currentUserReference],
                            };

...
import 'my_visions_copy_model.dart';
export 'my_visions_copy_model.dart';

class MyVisionsCopyWidget extends StatefulWidget {
  const MyVisionsCopyWidget({
    Key? key,
    int? index,
  })  : this.index = index ?? 0,
        super(key: key);
  ...
  @override
  _MyVisionsCopyWidgetState createState() => _MyVisionsCopyWidgetState();
}

class _MyVisionsCopyWidgetState extends State<MyVisionsCopyWidget>
    with TickerProviderStateMixin {
  late MyVisionsCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyVisionsCopyModel());
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          '3lywg6tv' /* A list of your visions below. */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodySmall,
                                      ),
                                        ...
                                        return MasonryGridView.count(
                                          ...
                                          itemBuilder:
                                            ...
                                            final staggeredViewProjectsRecord =
                                                staggeredViewProjectsRecordList[
                                                    staggeredViewIndex];
                                            return custom_widgets.MyVisionCard(
                                              width: MediaQuery.of(context)
                                                      .size
                                                      .width *
                                                  1.0,
                                              height: 100.0,
                                              image: staggeredViewProjectsRecord
                                                  .image,
                                              title: staggeredViewProjectsRecord
                                                  .projectName,
                                            );
                                          },
                                        );
                                          ...
                                          child: AuthUserStreamWidget(
                                            builder: (context) => Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '64mlaxst' /* There are no current short ter... */,
                                              ),
                                        ...
                                        Padding(
                                          ...
                                          child: AuthUserStreamWidget(
                                            builder: (context) => Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '2zg87aas' /* There are no current long term... */,
                                              ),
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                        ...
                                        Padding(
                                          ...
                                          child: AuthUserStreamWidget(
                                            builder: (context) => Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'xq49g02d' /* No visions have been completed... */,
                                              ),
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)

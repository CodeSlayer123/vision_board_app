                              ...
                              children: [
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                        ...
                                        await showDialog<bool>(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  ...
                                                  content: Text(
                                                      'Are you sure you want t delete this account? This action can not be undone'),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(
                                    ...
                                    context.goNamedAuth('myVisions', mounted);
                                  },
                                  text: FFLocalizations.of(context).getText(
                                    '2ue4y5b6' /* Delete Account */,
                                  ),
                                  options: FFButtonOptions(
                                    width: 192.0,
                                    height: 44.0,

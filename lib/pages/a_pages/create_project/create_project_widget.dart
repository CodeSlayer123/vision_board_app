...
class _CreateProjectWidgetState extends State<CreateProjectWidget> {
  ...
  void initState() {
    ...
    _model.visionNameController ??= TextEditingController();
                                  ...
                                  children: [
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          16.0, 16.0, 16.0, 0.0),
                                      child: TextFormField(
                                        controller: _model.visionNameController,
                                        obscureText: false,
                          ...
                          children: [
                            Expanded(
                              child: SwitchListTile(
                                ...
                                subtitle: Text(
                                  FFLocalizations.of(context).getText(
                                    '5z5b1zxp' /* All users in the same orginaza... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .titleSmall
                                      .override(
                        ...
                        Row(
                          ...
                          children: [
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  if (_model.visionNameController.text ==
                                          null ||
                                      _model.visionNameController.text == '') {
                                  ...
                                  if (_model.choiceChipsValue == 'Short Term') {
                                    final usersUpdateData1 = {
                                      'shortTerms': FieldValue.increment(1),
                                    };
                                    await currentUserReference!
                                        .update(usersUpdateData1);
                                  } else {
                                    final usersUpdateData2 = {
                                      'longTerms': FieldValue.increment(1),
                                    };
                                    await currentUserReference!

...
import 'new_create_task_model.dart';
export 'new_create_task_model.dart';

class NewCreateTaskWidget extends StatefulWidget {
  const NewCreateTaskWidget({
    Key? key,
  ...
  @override
  _NewCreateTaskWidgetState createState() => _NewCreateTaskWidgetState();
}

class _NewCreateTaskWidgetState extends State<NewCreateTaskWidget>
    with TickerProviderStateMixin {
  late NewCreateTaskModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewCreateTaskModel());
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        '37xb9x2t' /* Enter description here... */,
                                      ),
                                ...
                                Padding(
                                  ...
                                  child: FlutterFlowDropDown<String>(
                                    ...
                                    options: [
                                      FFLocalizations.of(context).getText(
                                        'awaf4zai' /* Not Started */,
                                      ),
                                      FFLocalizations.of(context).getText(
                                        'ucbtbwso' /* In Progress */,
                                      ),
                                      FFLocalizations.of(context).getText(
                                        'wwy89s4g' /* Complete */,
                                      )
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                context.pushNamed(
                                  ...
                                  extra: <String, dynamic>{
                                    'projectRef': widget.projectParameter,

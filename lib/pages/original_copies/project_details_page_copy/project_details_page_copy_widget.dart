...
import 'project_details_page_copy_model.dart';
export 'project_details_page_copy_model.dart';

class ProjectDetailsPageCopyWidget extends StatefulWidget {
  const ProjectDetailsPageCopyWidget({
    Key? key,
    this.projectRef,
  }) : super(key: key);
  ...
  @override
  _ProjectDetailsPageCopyWidgetState createState() =>
      _ProjectDetailsPageCopyWidgetState();
}

class _ProjectDetailsPageCopyWidgetState
    extends State<ProjectDetailsPageCopyWidget> with TickerProviderStateMixin {
  late ProjectDetailsPageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProjectDetailsPageCopyModel());

...
import 'main_projects_web_copy_model.dart';
export 'main_projects_web_copy_model.dart';

class MainProjectsWebCopyWidget extends StatefulWidget {
  const MainProjectsWebCopyWidget({Key? key}) : super(key: key);

  @override
  _MainProjectsWebCopyWidgetState createState() =>
      _MainProjectsWebCopyWidgetState();
}

class _MainProjectsWebCopyWidgetState extends State<MainProjectsWebCopyWidget>
    with TickerProviderStateMixin {
  late MainProjectsWebCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainProjectsWebCopyModel());
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      's2bqgujy' /* A list of your projects below. */,
                                    ),
                                    style:
